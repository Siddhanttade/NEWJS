...
setInterval(function(){
  let date=new Date() //object is created for date
...
const startChangingColor=function(){
  if(!intervalId){ //Here we check the interval beacuse null is used
...
const stopChangingColor=function(){
  ...
  intervalId=null //here we flush the values used earlier. variable is dereferenced after this
}
